...
let screen42 = new MainContent(
    ...
    "screen43.changeContent(); document.querySelector('.loading-label').innerHTML = 'Свет гаснет и&nbspголос сообщает, что ваш ребёнок прошёл бы проверку и&nbspбыл бы принят в&nbspсуперкрутую школу будущего!'; document.querySelector('.loading-text').innerHTML = 'Мы выяснили, кем он могли бы стать в&nbspнашей школе будущего! Хотите узнать результаты?';"
)
